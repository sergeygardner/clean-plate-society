//
//  ModifyProfileThemeViewTest.swift
...
struct ModifyProfileThemeViewTest {
  @Test func testEnglishFormalLight() async throws {
    let view = PreviewContainerView {
      Form {
        ModifyProfileThemeView(theme: .constant(Theme.formal))
  ...
  @Test func testEnglishRoyalLight() async throws {
    let view = PreviewContainerView {
      Form {
        ModifyProfileThemeView(theme: .constant(Theme.royal))
  ...
  @Test func testEnglishForestLight() async throws {
    let view = PreviewContainerView {
      Form {
        ModifyProfileThemeView(theme: .constant(Theme.forest))
  ...
  @Test func testEnglishHarvestLight() async throws {
    let view = PreviewContainerView {
      Form {
        ModifyProfileThemeView(theme: .constant(Theme.harvest))
  ...
  @Test func testEnglishMidnightLight() async throws {
    let view = PreviewContainerView {
      Form {
        ModifyProfileThemeView(theme: .constant(Theme.midnight))
